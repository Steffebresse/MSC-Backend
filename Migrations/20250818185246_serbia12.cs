...
{
    /// <inheritdoc />
    public partial class serbia12 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserMovie", x => new { x.MoviesId, x.mSCUsersId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Id", "Actors", "Directors", "ImdbId", "MscRating", "Plot", "Poster", "ReleaseDate", "Runtime", "Title" },
                values: new object[] { new Guid("aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee"), "[]", "[]", "", 0f, "", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", "TestTitle" });

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserMovie_mSCUsersId",
